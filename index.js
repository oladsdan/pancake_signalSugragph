...
async function signalGenerationLoop() {
    ...
    for (const tokenConfig of config.monitoredTokens) {
        ...
        try {
            ...
            const { pairAddress, pairName, baseToken, quoteToken, currentPrice, currentVolume, currentLiquidity } = marketData;
            ...
            await dataService.initializeTokenData({
                ...
                // You might need to adjusst dataService.initializeTokenData if it expects a 'name' field for quoteToken.
